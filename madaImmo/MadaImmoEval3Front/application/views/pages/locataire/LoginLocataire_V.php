                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto">
                        <div class="personnalizedForm auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <form action="<?php echo base_url("Login_C/locataireLogin"); ?>" method="post" class="pt-3">
                                <div class="form-group">
                                    <label for="email"> saisissez votre email :</label>
                                    <input type="email" name="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="adresse email" value="rakoto@gmail.com">
                                </div>
                                <div class="mt-3">
